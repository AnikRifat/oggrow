                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="widget-26-job-emp-img">
                                                                    <img
                                                                      src="https://Anikrifat/img/Content/avatar/avatar5.png"
                                                                      alt="Company" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="widget-26-job-title">
                                                                    <a href="#">Senior Software Engineer /
                                                                        Developer</a>
                                                                    <p class="m-0"><a href="#"
                                                                          class="employer-name">Axiom Corp.</a> <span
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="widget-26-job-emp-img">
                                                                    <img
                                                                      src="https://Anikrifat/img/Content/avatar/avatar2.png"
                                                                      alt="Company" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="widget-26-job-title">
                                                                    <a href="#">Marketing &amp; Communication
                                                                        Supervisor</a>
                                                                    <p class="m-0"><a href="#"
                                                                          class="employer-name">AxiomUI Llc.</a> <span
                                                            ...
                                                            <td>
                                                                <div class="widget-26-job-info">
                                                                    ...
                                                                    <p class="text-muted m-0">in <span
                                                                          class="location">New York, US</span></p>
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="widget-26-job-emp-img">
                                                                    <img
                                                                      src="https://Anikrifat/img/Content/avatar/avatar3.png"
                                                                      alt="Company" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="widget-26-job-title">
                                                                    ...
                                                                    <p class="m-0"><a href="#"
                                                                          class="employer-name">AxiomUI Inc.</a> <span
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="widget-26-job-emp-img">
                                                                    <img
                                                                      src="https://Anikrifat/img/Content/avatar/avatar4.png"
                                                                      alt="Company" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="widget-26-job-emp-img">
                                                                    <img
                                                                      src="https://Anikrifat/img/Content/avatar/avatar6.png"
                                                                      alt="Company" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="widget-26-job-emp-img">
                                                                    <img
                                                                      src="https://Anikrifat/img/Content/avatar/avatar7.png"
                                                                      alt="Company" />
                                                                </div>
                                                            </td>
                                                            <td>
